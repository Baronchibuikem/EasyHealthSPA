<template>
  <div>
      ...
      <div class="container">
        <div class="md-toolbar-row">
          ...
          <div id="user_menu" class="md-toolbar-section-end" v-if="isAuthenticated">
            <md-menu md-direction="bottom-end" md-align-trigger class="user_menu" :md-offset-y="14">
    ...
    <md-app-drawer :md-active.sync="menuVisible" v-else>
          ...
          <div class="border-top border-bottom">
            <md-list class="md-triple-line md-dense pt-1">
              ...
              <md-list-item class="bluish-hue mx-1 mb-2 rounded">
                ...
                <div class="md-list-item-text">
                  <span class="name">Scott Jennifer</span>
                  <p class="text-muted date mt-1">13th June, 2018</p>
                </div>
              ...
              <md-list-item class="bluish-hue mx-1 mb-2 rounded">
                ...
                <div class="md-list-item-text">
                  <span class="name">Sandra Adams</span>
                  <p class="text-muted date mt-1">19th sept, 2018</p>
                </div>
